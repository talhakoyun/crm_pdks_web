...
<div class="dropdown">
                    <button style="background: darkgray;" class="d-flex justify-content-center align-items-center rounded-circle" type="button"
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div
                            ...
                            <div>
                                <h6 class="text-lg text-primary-light fw-semibold mb-2">{{$authUser->name }} {{$authUser->surname}}</h6>
                                <span class="text-secondary-light fw-medium text-sm">{{$authUser->title}}</span>
                            </div>
                        ...
                        <ul class="to-top-list">
                            <li>
                                <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3"
                                    ...
                                    style="pointer-events: auto !important; text-decoration: none !important;"
                                    onclick="window.location.href='{{ route('backend.profile') }}'; return false;">
