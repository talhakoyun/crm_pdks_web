                ...
                columns: [{
                    ...
                    },
                    {
                        render: function(data, type, row) {
                            return row.is_category == 1 ?
                                '<span class="bg-success-focus text-success-600 border border-success-main px-24 py-4 radius-4 fw-medium text-sm"> Evet </span>' :
                                '<span class="bg-danger-focus text-danger-600 border border-danger-main px-24 py-4 radius-4 fw-medium text-sm"> Hayır </span>';
                        },
                        data: null,
                        orderable: false,
                        searchable: false,
